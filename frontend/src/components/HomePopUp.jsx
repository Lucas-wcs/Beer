                ...
                <div className='PopUpContent'>
                    ...
                    <div className='PopUpAllParts'>
                        ...
                        <div className='PopUpRightPart'>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam et vestibulum velit, dictum cursus ex. Nullam pharetra pharetra venenatis. Duis est metus, convallis eget vehicula vel, pellentesque non diam. Aliquam laoreet, mi ut rhoncus laoreet, sem nibh fringilla lacus, a tincidunt lorem metus ac velit.</p>
